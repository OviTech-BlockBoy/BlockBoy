...
## Prerequisites
A working installation of [ESP-IDF](https://docs.espressif.com/projects/esp-idf/en/latest/esp32s3/get-started/) v4.4 - v5.x is required.
...
```bash
python rg_tool.py --target 0v1Tech-BlockBoy-N16R8 --port COM3 run launcher
python rg_tool.py --target 0v1Tech-BlockBoy-N16R8 --port COM3 run retro-core
python rg_tool.py --target 0v1Tech-BlockBoy-N16R8 --port COM3 run gwenesis
python rg_tool.py --target 0v1Tech-BlockBoy-N16R8 --port COM3 run prboom-go
```
