#if defined(RG_TARGET_0V1TECH_BLOCKBOY_N16R8)
#include "targets/0v1Tech-BlockBoy-N16R8/config.h"
#else
#error "No target defined. Use --target 0v1Tech-BlockBoy-N16R8"
#endif
...
// Disabled on BlockBoy: this updater points at upstream ducalex/retro-go
// releases (wrong firmware for this device) and TLS certificate validation is
// off in sdkconfig, so the download path is MITM-able. BlockBoy has its own
// OTA updater instead.
