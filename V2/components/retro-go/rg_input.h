...
// Keys in this mask are passed to the app instead of being intercepted for volume/brightness (e.g. GBA L/R)
...
// Runtime divider/ADC calibration trim, as a percentage of the compile-time
// RG_BATTERY_VDIV_RATIO (100 = unchanged). Persisted across reboots.
