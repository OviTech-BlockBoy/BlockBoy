...
#ifdef ESP_PLATFORM
// Guard against flashing the wrong BlockBoy variant. V2 (N16R8) ships with a
// 16MB flash chip; V1 (N4R2) has 4MB. FLASHSIZE_DETECT is enabled, so
...
#define BLOCKBOY_EXPECTED_FLASH_MB 16
static void check_hardware_variant(void)
{
    ...
    rg_gui_draw_text(0, h / 2 - 8, w,
                     "This is a BlockBoy V1 (N4R2).\n"
                     "You flashed the V2 firmware.\n"
                     "Please flash the V1 version.",
