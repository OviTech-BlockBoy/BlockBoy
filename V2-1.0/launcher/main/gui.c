...
#define SETTING_DISPLAY_MODE    "DisplayMode"
...
void gui_init(bool cold_boot)
{
    gui = (retro_gui_t){
        ...
        .bootanim     = rg_settings_get_number(NS_GLOBAL, SETTING_BOOTANIM, BOOTANIM_SCROLL),
        .display_mode = rg_settings_get_number(NS_GLOBAL, SETTING_DISPLAY_MODE, DISPLAY_MODE_OFF),
...
void gui_save_config(void)
{
    ...
    rg_settings_set_number(NS_GLOBAL, SETTING_BOOTANIM, gui.bootanim);
    rg_settings_set_number(NS_GLOBAL, SETTING_DISPLAY_MODE, gui.display_mode);
