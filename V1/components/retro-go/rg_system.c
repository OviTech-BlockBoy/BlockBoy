...
static const char *SETTING_BATTERY_WARN_VOLTAGE = "BattWarnV";
...
static void system_monitor_task(void *arg)
{
    ...
    while (!exitCalled)
    {
        ...
        int warn_mv = rg_settings_get_number(NS_GLOBAL, SETTING_BATTERY_WARN_VOLTAGE, 3300);
...
rg_app_t *rg_system_init(int sampleRate, const rg_handlers_t *handlers, void *_unused)
{
    ...
    {
        // gnuboy GB_PALETTE_DMG lightest shade — matches menus and in-game dialogs
        const rg_color_t DMG_BG = 0x94C0;  // #949C00 - yellow-olive background
