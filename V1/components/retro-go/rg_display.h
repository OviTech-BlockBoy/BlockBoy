...
// Visible-area margins in pixels — shrinks the rendered image inward on each
// side so it fits behind a smaller case window. Persisted to NVS, applied live,
// max ~25% of screen per side.
