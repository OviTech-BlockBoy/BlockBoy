...
// Alias used by the ported virtual keyboard / input_str code
#define rg_utf8_decode rg_utf8_get_codepoint
// Encode a codepoint into UTF-8 bytes; returns number of bytes written (1-4) or 0 on error
