...
static const char *language_names[RG_LANG_MAX] = {"English"};

// Compiled out while English is the only language -- see the enum in
// rg_localization.h. Kept so a new language only needs its lines added.
#if RG_LANG_MAX > 1
static const char *translations[][RG_LANG_MAX] =
{
    ...
    {
        [RG_LANG_EN] = "Status LED",
    },
    {
        [RG_LANG_EN] = "Low batt. blink",
    },
    {
        [RG_LANG_EN] = "Default",
    },
