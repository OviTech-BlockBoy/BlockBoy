# Notes:
# - BlockBoy V3 (ESP32-S3 N16R8, 16MB Flash, 8MB PSRAM)
...
# flasher. Also bump RG_LAYOUT_VERSION in the target config.h so the OTA server
# does not offer old devices an incompatible update.
...
PROJECT_FLASHER = ['flasher', 0xA0000]  # 640K (binary ~514K)
...
# flashing.
#
# The 4MB V1 has no room for this; it only carries two apps.
PROJECT_SPARE_APPS = [
  ('app5', 0x1C0000),  # 1.75M
  ('app6', 0x1C0000),  # 1.75M
]
