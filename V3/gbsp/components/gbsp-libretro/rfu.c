...
// RFU is disabled on BlockBoy (SERIAL_MODE_DISABLED); the large buffers need not
// cost internal RAM (the D/IRAM arena is full) → PSRAM BSS.
#ifdef ESP_PLATFORM
#include "esp_attr.h"
#define RFU_BSS EXT_RAM_BSS_ATTR
#else
#define RFU_BSS
#endif
...
static RFU_BSS u32 rfu_buf[255];
...
static RFU_BSS t_client_broadcast rfu_peer_bcst[MAX_RFU_PEERS];
